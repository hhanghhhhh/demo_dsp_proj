...
*/
	ECanbRegs.CANMD.bit.MD0 	= 0;		// define mail-box 0 is transimit
	ECanbRegs.CANMD.bit.MD16 	= 0x1;		// define mail-box 16 is reciver
	ECanbRegs.CANMD.bit.MD17 	= 0x1;		// define mail-box 16 is reciver
		
	ECanbRegs.CANME.all 		= 0xFFFFFFFF;
	
	ECanbMboxes.MBOX0.MSGCTRL.bit.DLC 	= 8;
	ECanbMboxes.MBOX16.MSGCTRL.bit.DLC 	= 8;		  // Specify that 8 bits will be sent/received
	ECanbMboxes.MBOX17.MSGCTRL.bit.DLC 	= 8;

	ECanbMboxes.MBOX0.MDL.all = 0x9555AAA0;
	ECanbMboxes.MBOX0.MDH.all = 0x89ABCDEF;

	ECanbMboxes.MBOX16.MDL.all = 0x0;
	ECanbMboxes.MBOX16.MDH.all = 0x89ABCDEF;

	ECanbMboxes.MBOX17.MDL.all = 0x0;
	ECanbMboxes.MBOX17.MDH.all = 0x89ABCDEF;
}
#endif

void InitECanMBox(void)
{
#if DSP28_ECANA
	InitEcanaMBox();
#endif
