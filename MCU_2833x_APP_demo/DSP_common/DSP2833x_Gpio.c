...
//   GpioCtrlRegs.GPADIR.bit.GPIO26   = 1;    //SPI_R
//   SPI_R_H;   //初始化为高电平
//
   GpioCtrlRegs.GPCDIR.bit.GPIO86   = 1;    //RESET_CMD fpga RESET信号
   RESET_CMD_L;  //初始化为低电平，高电平时reset，防止下载程序时FPGA错误动作。（下程序引脚高）

   //W5500
   GpioCtrlRegs.GPADIR.bit.GPIO19 = 1;  //CSn
   GpioCtrlRegs.GPADIR.bit.GPIO24 = 1;  //RST
   GpioCtrlRegs.GPADIR.bit.GPIO25 = 1;  //INIT
