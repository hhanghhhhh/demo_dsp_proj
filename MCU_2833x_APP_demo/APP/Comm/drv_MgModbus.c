...
static Uint16 MsgHandle(Uint16* pRxdata, Uint16* pTxdata)
{
   ...
   switch(funcode)
   {
        case READ_MULT:
            ...
            if(rmulti_rst == 0)     rmulti_rst = ReadRegisters(pTxdata, startaddr, regnum, md_rw3_buf, MD_RW3_START_ADDR, MD_RW3_END_ADDR, &sendnum);
        ...
        case WRITE_SINGLE:
            ...
            if(wsigle_rst == 0)     wsigle_rst = WriteSingleRegister(startaddr, u16RegValue, md_rw3_buf, MD_RW3_START_ADDR, MD_RW3_END_ADDR);
        ...
        case WRITE_MULT:
            ...
            if(wmulti_rst == 0)     wmulti_rst = WriteMultipleRegisters(startaddr, regnum, pRxdata, md_rw3_buf, MD_RW3_START_ADDR, MD_RW3_END_ADDR);
