 ...
 */
#include "Flash.h"
#pragma CODE_SECTION(FlashAPI_Init,"ramfuncs");
...
#pragma CODE_SECTION(Flash_Erase_App,"ramfuncs");
Uint16 Flash_Erase_App(void)
{
    FLASH_ST Flash_Status;
    ...
    Uint16 sector = 0x00;
    sector = SECTORF|SECTORE|SECTORD;

    if(0 == Flash_Erase(sector, &Flash_Status)){
        result = 0;
    }
